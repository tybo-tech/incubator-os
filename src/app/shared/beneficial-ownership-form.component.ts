...
@Component({
  selector: 'app-beneficial-ownership-form',
  standalone: true,
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div class="bg-white rounded-xl shadow-xl w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
          <h3 class="text-lg font-semibold text-gray-900">{{ isEdit() ? 'Edit' : 'New' }} Beneficial Ownership Declaration</h3>
        ...
        <div class="p-6 space-y-4">
          <div>
            <label class="block text-sm font-medium text-gray-700 mb-1">Declaration Type</label>
            <select [(ngModel)]="form.declarationType" class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm">
          ...
          <div class="grid grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="date" [(ngModel)]="form.submittedDate" class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm" />
            </div>
          </div>
          <div>
...
export class BeneficialOwnershipFormComponent implements OnInit {
