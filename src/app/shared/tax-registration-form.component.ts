...
@Component({
  selector: 'app-tax-registration-form',
  standalone: true,
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div class="bg-white rounded-xl shadow-xl w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
          <h3 class="text-lg font-semibold text-gray-900">{{ isEdit() ? 'Edit' : 'New' }} Tax Registration</h3>
        ...
        <div class="p-6 space-y-4">
          <div>
            ...
            <select [(ngModel)]="form.registrationType" class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm">
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <input type="date" [(ngModel)]="form.registrationDate" class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm" />
            </div>
            <div>
              <label class="block text-sm font-medium text-gray-700 mb-1">Next Filing Due</label>
              <input type="date" [(ngModel)]="form.nextFilingDueDate" class="w-full border border-gray-300 rounded-md px-3 py-2 text-sm" />
            </div>
          </div>
          <div>
...
export class TaxRegistrationFormComponent implements OnInit {
