...
@Component({
  ...
  template: `
    <div class="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
      <div class="bg-white rounded-xl shadow-xl w-full max-w-lg max-h-[90vh] flex flex-col overflow-hidden mx-4" (click)="$event.stopPropagation()">
        ...
        <div class="p-6 space-y-4 flex-1 overflow-y-auto min-h-0" *ngIf="record() as r">
        ...
        <div class="flex items-center justify-end px-6 py-4 border-t border-gray-200 shrink-0">
