...
@Component({
  ...
  template: `
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8" *ngIf="company">
      ...
      <div class="bg-gray-50 rounded-lg p-4">
        ...
        <div class="text-sm text-gray-900">
          {{ (company.turnover_estimated || 0) | currency:'ZAR' }}
        </div>
      </div>
    </div>

    <div *ngIf="!company" class="text-center py-8">
      <div class="animate-spin rounded-full h-8 w-8 border-b-2 border-blue-600 mx-auto"></div>
      <p class="text-gray-500 mt-2">Loading financial overview...</p>
    </div>
  `
})
