// assessment-tab-consolidated.component.ts - Updated component using consolidated data approach
...
import { ConsolidatedQuestionnaireService } from '../../../../../services/consolidated-questionnaire.service';
...
@Component({
  selector: 'app-assessment-tab-consolidated',
  standalone: true,
...
export class AssessmentTabConsolidatedComponent implements OnInit, OnDestroy {
  ...
  consolidatedAssessment: ConsolidatedAssessmentResponse | null = null;
  autoSaveStatus = '';
  ...
  constructor(
    private consolidatedQuestionnaireService: ConsolidatedQuestionnaireService,
  ...
  private loadConsolidatedData(): void {
    ...
    this.consolidatedQuestionnaireService.getConsolidatedAssessment(this.company.id)
      .pipe(takeUntil(this.destroy$))
  ...
  saveProgress(): void {
    ...
    this.consolidatedQuestionnaireService.savePartialResponse(
      this.company.id,
  ...
  onFormDataChange(): void {
    ...
    if (this.company?.id) {
      this.consolidatedQuestionnaireService.updateCurrentSection(
        this.company.id,
  ...
  private updateProgress(): void {
    ...
    this.progress = this.consolidatedQuestionnaireService.calculateProgress(
      this.questionnaire,
  ...
  private saveCurrentSectionAsComplete(): void {
    ...
    this.consolidatedQuestionnaireService.markSectionComplete(
      this.company.id,
      this.questionnaire.id,
      this.currentSection.id
    ).pipe(takeUntil(this.destroy$))
