    ...
    >
      ...
      <div *ngIf="!isLoading()" class="p-6">
        ...
        <div class="border rounded-lg p-3 mb-6 bg-gray-50">
          <div class="grid grid-cols-4 gap-2">
            <div class="text-center p-2">
              <div
                class="flex items-center justify-center w-6 h-6 rounded-full bg-blue-100 text-blue-600 text-xs font-semibold mx-auto mb-1"
              >
                1
              </div>
            ...
            <div class="text-center p-2">
              <div
                class="flex items-center justify-center w-6 h-6 rounded-full bg-yellow-100 text-yellow-600 text-xs font-semibold mx-auto mb-1"
              >
                2
              </div>
            ...
            <div class="text-center p-2">
              <div
                class="flex items-center justify-center w-6 h-6 rounded-full bg-orange-100 text-orange-600 text-xs font-semibold mx-auto mb-1"
              >
                3
              </div>
            ...
            <div class="text-center p-2">
              <div
                class="flex items-center justify-center w-6 h-6 rounded-full bg-purple-100 text-purple-600 text-xs font-semibold mx-auto mb-1"
              >
                4
              </div>
        ...
        <div class="border rounded-xl p-4 mb-6 bg-white shadow-sm">
          <div class="overflow-x-auto">
            <table class="w-full text-sm">
              <thead>
                <tr class="bg-gray-50">
                  <th class="text-left px-3 py-2 font-medium text-gray-700">
                    Supplier
                  </th>
                  <th class="text-left px-3 py-2 font-medium text-gray-700">
                    Current Step
              ...
              <tbody>
                <tr
                  *ngFor="
                    let item of scmVerification().quotations.items;
                    let i = index
                  "
                ...
                >
                  ...
                  <td class="px-3 py-2">
                    <span
                      ...
                      {{
                        getQuotationStep(item) === 1
                          ? 'bg-green-100 text-green-800'
                          : getQuotationStep(item) === 2
                            ? 'bg-yellow-100 text-yellow-800'
                            : getQuotationStep(item) === 3
                ...
                <tr *ngIf="scmVerification().quotations.items.length === 0">
                  ...
                  >
                    ...
                    <p>
                      No quotations added yet. Click "Add Quotation" to get
                      started.
                    </p>
                  </td>
                </tr>
        ...
        >
          <div class="flex">
            <i
              class="fas text-base mt-0.5 mr-2"
              [class]="
                saveStatus()!.type === 'success'
      ...
      >
        ...
        >
          <h3 class="text-base font-semibold text-gray-900">
            {{
              currentQuotationIndex() !== null
                ? scmVerification().quotations.items[currentQuotationIndex()!]
                    .supplier_name
                : ''
            }}
            -
        ...
        <div class="p-5">
          ...
          <div *ngIf="currentStep() === 2 && currentQuotationIndex() !== null">
            <h4 class="font-medium text-gray-900 mb-3 text-sm">
              Online Verification of Suppliers
            </h4>
            <div
              *ngIf="
                scmVerification().quotations.items[currentQuotationIndex()!]
            ...
            >
              <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                <div>
                  <label class="block text-xs font-medium text-gray-700 mb-1"
                    >CIPC Registration</label
                  >
                  <input
                    type="text"
                    [(ngModel)]="
                      scmVerification().quotations.items[
                        currentQuotationIndex()!
                      ].online_verification!.cipc_registration
                    "
                  ...
                  <div class="flex items-center">
                    <input
                      ...
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].online_verification!.cipc_verified
                      "
                ...
                <div>
                  ...
                  <input
                    ...
                    [(ngModel)]="
                      scmVerification().quotations.items[
                        currentQuotationIndex()!
                      ].online_verification!.vat_number
                    "
                  ...
                  <div class="flex items-center">
                    <input
                      ...
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].online_verification!.vat_verified
                      "
                      class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                    <label class="ml-2 text-xs text-gray-700">Verified</label>
              ...
              <div class="border rounded-lg p-3 mb-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].online_verification!.contact_details.phone
                      "
                  ...
                  <div>
                    ...
                    <input
                      ...
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].online_verification!.contact_details.email
                      "
                  ...
                  <div>
                    ...
                    <input
                      ...
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].online_verification!.contact_details.address
                      "
                ...
                <div class="mt-2">
                  <label class="block text-xs font-medium text-gray-700 mb-1"
                    >Contact Details Verified</label
                  >
                  <div class="flex items-center">
                    <input
                      type="checkbox"
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].online_verification!.contact_details.verified
                      "
                      class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                    <label class="ml-2 text-xs text-gray-700">Verified</label>
              ...
              <div class="mb-3">
                <label class="block text-xs font-medium text-gray-700 mb-1"
                  >Comments/Next Steps</label
                >
                <textarea
                  [(ngModel)]="
                    scmVerification().quotations.items[currentQuotationIndex()!]
                      .online_verification!.comments
                  "
          ...
          <div *ngIf="currentStep() === 3 && currentQuotationIndex() !== null">
            <h4 class="font-medium text-gray-900 mb-3 text-sm">
              Processing Verified Quotations (Generate PO)
            </h4>
            <div
              *ngIf="
                scmVerification().quotations.items[currentQuotationIndex()!]
            ...
            >
              <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                <div>
                  <label class="block text-xs font-medium text-gray-700 mb-1"
                    >Purchase Order Generated</label
                  >
                  <div class="flex items-center">
                    <input
                      type="checkbox"
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].purchase_order_processing!.purchase_order_generated
                      "
                      class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                ...
                <div>
                  <label class="block text-xs font-medium text-gray-700 mb-1"
                    >Emailed to Supplier Date</label
                  >
                  <input
                    type="date"
                    [(ngModel)]="
                      scmVerification().quotations.items[
                        currentQuotationIndex()!
                      ].purchase_order_processing!.emailed_to_supplier_date
                    "
                    class="w-full text-sm border border-gray-300 rounded-lg px-2 py-1.5 focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
                  ...
                  <div class="flex items-center">
                    <input
                      ...
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].purchase_order_processing!.tax_invoice_received
                      "
                      class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                ...
                <div>
                  <label class="block text-xs font-medium text-gray-700 mb-1"
                    >BBBEE Certificate Received</label
                  >
                  <div class="flex items-center">
                    <input
                      type="checkbox"
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].purchase_order_processing!.bbbee_certificate_received
                      "
                      class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                    <label class="ml-2 text-xs text-gray-700">Received</label>
                ...
                <div>
                  <label class="block text-xs font-medium text-gray-700 mb-1"
                    >Bank Confirmation Received</label
                  >
                  <div class="flex items-center">
                    <input
                      type="checkbox"
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].purchase_order_processing!.bank_confirmation_received
                      "
                      class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                    <label class="ml-2 text-xs text-gray-700">Received</label>
                ...
                <div>
                  <label class="block text-xs font-medium text-gray-700 mb-1"
                    >Tax Clearance Certificate</label
                  >
                  <div class="flex items-center">
                    <input
                      type="checkbox"
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].purchase_order_processing!.tax_clearance_received
                      "
                      class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                    <label class="ml-2 text-xs text-gray-700">Received</label>
                  ...
                  <div class="flex items-center">
                    <input
                      ...
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].purchase_order_processing!.approved
                      "
                      class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                    <label class="ml-2 text-xs text-gray-700">Approved</label>
              ...
              <div class="mb-3">
                ...
                <textarea
                  [(ngModel)]="
                    scmVerification().quotations.items[currentQuotationIndex()!]
                      .purchase_order_processing!.comments
                  "
                  placeholder="Enter comments or next steps"
                  class="w-full text-sm border border-gray-300 rounded-lg px-2 py-1.5 focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  rows="2"
          ...
          <div *ngIf="currentStep() === 4 && currentQuotationIndex() !== null">
            ...
            >
              <div class="grid grid-cols-1 md:grid-cols-2 gap-3 mb-3">
                  ...
                  <div class="flex items-center">
                    <input
                      ...
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].payment_processing!.vat_invoice_received
                      "
                      class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                    <label class="ml-2 text-xs text-gray-700">Received</label>
                  ...
                  <div class="flex items-center">
                    <input
                      ...
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].payment_processing!.bank_confirmation_received
                      "
                      class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                    <label class="ml-2 text-xs text-gray-700">Received</label>
                ...
                <div>
                  <label class="block text-xs font-medium text-gray-700 mb-1"
                    >Payment Authorization Signed</label
                  >
                  <div class="flex items-center">
                    <input
                      type="checkbox"
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].payment_processing!.payment_authorisation_signed
                      "
                      class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                ...
                <div>
                  ...
                  <input
                    ...
                    [(ngModel)]="
                      scmVerification().quotations.items[
                        currentQuotationIndex()!
                      ].payment_processing!.payment_request_date
                    "
                    class="w-full text-sm border border-gray-300 rounded-lg px-2 py-1.5 focus:ring-1 focus:ring-blue-500 focus:border-transparent"
                  />
                </div>
                  ...
                  <div class="flex items-center">
                    <input
                      ...
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].payment_processing!.payment_done
                      "
                      class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                  ...
                  <div class="flex items-center">
                    <input
                      ...
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].payment_processing!.proof_of_payment_sent
                      "
                      class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                  ...
                  <div class="flex items-center">
                    <input
                      ...
                      [(ngModel)]="
                        scmVerification().quotations.items[
                          currentQuotationIndex()!
                        ].payment_processing!.delivery_note_received
                      "
                      class="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
                    />
                    <label class="ml-2 text-xs text-gray-700">Received</label>
...
export class ScmVerificationProcessComponent implements OnInit {
  ...
  saveStatus = signal<{ message: string; type: 'success' | 'error' } | null>(
    null,
  );
  ...
  constructor(
    ...
    @Inject(ScmVerificationStateService) private stateService: ScmVerificationStateService
  ) {}
  ...
  loadScmVerification(): void {
    ...
    this.nodeService
      .getNodes('grant_scm_verification', this.companyId)
      .subscribe({
        next: (nodes: any[]) => {
          if (nodes.length > 0) {
    ...
    scmData.quotations.items.forEach((quotation) => {
      if (quotation.supplier_name) {
        const supplier: Supplier = {
          ...
          cipc_registration:
            quotation.online_verification?.cipc_registration || '',
          ...
          contact_details: {
            ...
            address:
              quotation.online_verification?.contact_details.address || '',
            verified:
              quotation.online_verification?.contact_details.verified || false,
          },
  ...
  prepopulateCompanyInfo(): void {
    ...
    const directorName = primaryDirector
      ? [primaryDirector.name, primaryDirector.surname]
          .filter(Boolean)
          .join(' ')
      : '';
  ...
  getStepName(step: number): string {
    switch (step) {
      case 1:
        return 'Collection of Quotations';
      case 2:
        return 'Online Verification of Suppliers';
      case 3:
        return 'Processing Verified Quotations (Generate PO)';
      case 4:
        return 'Processing Payment Authorization/Payment';
      default:
        return 'Unknown';
    }
  }
