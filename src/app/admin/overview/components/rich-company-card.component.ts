...
@Component({
  ...
  template: `
    <div class="bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow border border-gray-200 p-4 sm:p-6">
      ...
      <div class="block lg:hidden space-y-4">
        ...
        <div class="flex items-start justify-between">
          <div class="flex items-center space-x-3 flex-1 min-w-0">
            <!-- Company Avatar -->
            <div class="w-10 h-10 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center text-white font-bold text-sm flex-shrink-0">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm text-gray-600">
          @if (company.registration_no) {
            <div class="flex items-center space-x-2">
              ...
              <span class="truncate">{{ company.registration_no }}</span>
            </div>
          }
          ...
          @if (company.business_location || company.city) {
            <div class="flex items-center space-x-2">
              ...
              <span class="truncate">{{ company.business_location || company.city }}</span>
            </div>
          }
          ...
          @if (company.contact_person) {
            <div class="flex items-center space-x-2">
              ...
              <span class="truncate">{{ company.contact_person }}</span>
            </div>
          }
        ...
        <div class="flex items-center justify-between border-t pt-3">
          ...
          @if (company.turnover_estimated) {
            <div class="text-center">
              <div class="text-xs text-gray-600">Turnover</div>
          ...
          @if (company.black_ownership || company.black_women_ownership || company.youth_owned) {
            <div class="flex space-x-1">
              @if (company.black_ownership) {
                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-purple-100 text-purple-800" title="Black Owned">B</span>
              }
              @if (company.black_women_ownership) {
                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-pink-100 text-pink-800" title="Women Owned">W</span>
              }
              @if (company.youth_owned) {
                <span class="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-orange-100 text-orange-800" title="Youth Owned">Y</span>
              }
            </div>
          }
          ...
          <div class="flex items-center space-x-3">
            <!-- Compliance Dots -->
            <div class="flex space-x-1">
              <div class="w-2 h-2 rounded-full" [class]="company.has_cipc_registration ? 'bg-green-400' : 'bg-red-400'" title="CIPC"></div>
              <div class="w-2 h-2 rounded-full" [class]="company.has_tax_clearance ? 'bg-green-400' : 'bg-red-400'" title="Tax"></div>
              <div class="w-2 h-2 rounded-full" [class]="company.has_valid_bbbbee ? 'bg-green-400' : 'bg-red-400'" title="BBBEE"></div>
            </div>

            <!-- Score -->
            <div class="w-8 h-8 rounded-full border-2 flex items-center justify-center text-xs font-bold" [class]="getScoreClasses(getComplianceScore())">
              {{ getComplianceScore() }}
            </div>

            <!-- Status -->
            <div class="px-2 py-1 rounded-full text-xs font-medium" [class]="getStatusClasses(company.cipc_status)">
